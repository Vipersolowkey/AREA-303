...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: "04", slug: "churn",            label: "Khách sắp rời",      href: "/seller/churn",            icon: UserMinus,     app: "seller", section: "intelligence", category: "Behavioral AI",   owner: "TL" },
  ...
  { id: "10", slug: "return-predict",   label: "Nguy cơ hoàn trả",   href: "/seller/return-predict",   icon: RotateCcw,     app: "seller", section: "intelligence", category: "Behavioral AI",   owner: "DA" },
  ...
  { id: "15", slug: "regret-predict",   label: "Hối tiếc sau mua",   href: "/seller/regret-predict",   icon: BadgePercent,  app: "seller", section: "intelligence", category: "Behavioral AI",   owner: "D1" },
...
export const SUBTITLE: Record<string, string> = {
  ...
  "churn": "Khách có nguy cơ rời đi và cách giữ chân.",
