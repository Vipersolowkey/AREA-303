...
small/medium Vietnamese clothing and fashion-accessories shop.
"""
...
def _gen_reviews(rng: random.Random, product_name: str, brand: str) -> list[dict]:
    ...
    for _ in range(n):
        ...
        tmpl = rng.choice(
            {5: _REVIEW_TEMPLATES_5, 4: _REVIEW_TEMPLATES_4, 3: _REVIEW_TEMPLATES_3}[r]
        )
    ...
    "Thời trang": {
        ...
        "items": [
            (
                ...
                (180000, 320000),
                {"chất liệu": "cotton", "form": "rộng"},
                "tshirt",
            ),
            (
                "Áo khoác dù 2 lớp",
                (280000, 520000),
                {"chất liệu": "dù", "form": "regular"},
                "bomber_jacket",
            ),
            ...
            (
                "Quần jean ống rộng",
                (300000, 550000),
                {"chất liệu": "denim", "form": "ống rộng"},
                "jeans",
            ),
            (
                "Áo sơ mi oversize",
                (220000, 400000),
                {"chất liệu": "kate", "form": "oversize"},
                "dress_shirt",
            ),
            ...
            (
                "Cardigan len mỏng",
                (260000, 490000),
                {"chất liệu": "len", "form": "regular"},
                "knitwear",
            ),
            (
                "Quần tây ống suông",
                (280000, 520000),
                {"chất liệu": "tuytsi", "form": "ống suông"},
                "jogger",
            ),
            (
                "Áo polo pique",
                (220000, 390000),
                {"chất liệu": "cotton pique", "form": "regular"},
                "polo",
            ),
            (
                "Đầm dự tiệc satin",
                (480000, 890000),
                {"chất liệu": "satin", "form": "ôm nhẹ"},
                "dress",
            ),
            (
                "Áo khoác denim unisex",
                (390000, 690000),
                {"chất liệu": "denim 12oz", "form": "rộng"},
                "denim_jacket",
            ),
            (
                "Quần jogger thể thao",
                (240000, 420000),
                {"chất liệu": "thun da cá", "form": "jogger"},
                "jogger",
            ),
            (
                "Áo hai dây basic",
                (90000, 190000),
                {"chất liệu": "cotton gân", "form": "ôm"},
                "crop_top",
            ),
            (
                "Áo măng tô dáng dài",
                (650000, 1200000),
                {"chất liệu": "dạ", "form": "dài"},
                "winter_coat",
            ),
        ],
    },
    "Mỹ phẩm": {
        ...
        "items": [
            ...
            (
                "Sữa rửa mặt dịu nhẹ",
                (110000, 260000),
                {"loại": "srm", "da": "nhạy cảm"},
                "face_wash",
            ),
            (
                "Mặt nạ ngủ dưỡng ẩm",
                (180000, 650000),
                {"loại": "mask", "công dụng": "cấp ẩm"},
                "face_mask",
            ),
            (
                "Cushion che khuyết điểm",
                (250000, 550000),
                {"loại": "cushion", "finish": "căng bóng"},
                "foundation",
            ),
            (
                "Retinol 0.5%",
                (220000, 480000),
                {"loại": "serum", "công dụng": "chống lão hoá"},
                "serum",
            ),
            (
                "Tẩy trang dầu",
                (130000, 290000),
                {"loại": "tẩy trang", "da": "mọi loại"},
                "face_wash",
            ),
            (
                "Kem dưỡng ẩm ban đêm",
                (200000, 450000),
                {"loại": "kem dưỡng", "công dụng": "phục hồi"},
                "moisturizer",
            ),
            (
                "Mascara làm dày mi",
                (160000, 330000),
                {"loại": "mascara", "finish": "dày"},
                "mascara",
            ),
            (
                "Niacinamide 10%",
                (180000, 360000),
                {"loại": "serum", "công dụng": "giảm thâm"},
                "serum",
            ),
            (
                "BHA 2% tẩy tế bào chết",
                (260000, 690000),
                {"loại": "treatment", "công dụng": "giảm mụn"},
                "serum",
            ),
            ...
            (
                "Nước hoa mini 10ml",
                (250000, 650000),
                {"loại": "nước hoa", "dung tích": "10ml"},
                "perfume",
            ),
            (
                "Kem nền kiềm dầu",
                (280000, 620000),
                {"loại": "kem nền", "finish": "lì"},
                "foundation",
            ),
            (
                "Mặt nạ đất sét",
                (180000, 420000),
                {"loại": "mask", "công dụng": "làm sạch"},
                "face_mask",
            ),
            (
                "Dầu gội phục hồi",
                (160000, 380000),
                {"loại": "chăm sóc tóc", "công dụng": "phục hồi"},
                "face_wash",
            ),
            (
                "Xịt khoáng làm dịu",
                (120000, 290000),
                {"loại": "xịt khoáng", "công dụng": "làm dịu"},
                "toner",
            ),
            (
                "Kẻ mắt chống nước",
                (130000, 310000),
                {"loại": "eyeliner", "finish": "chống nước"},
                "mascara",
            ),
        ],
    },
    "Phụ kiện": {
        ...
        "items": [
            (
                "Túi tote canvas",
                (120000, 250000),
                {"chất liệu": "canvas", "kiểu": "tote"},
                "tote_bag",
            ),
            (
                "Túi đeo chéo da PU",
                (200000, 420000),
                {"chất liệu": "da pu", "kiểu": "đeo chéo"},
                "crossbody_bag",
            ),
            (
                "Balo laptop chống nước",
                (300000, 650000),
                {"chất liệu": "poly", "kiểu": "balo"},
                "backpack",
            ),
            ...
            (
                "Kẹp tóc ngọc trai",
                (50000, 120000),
                {"chất liệu": "ngọc trai", "kiểu": "kẹp"},
                "earrings",
            ),
            (
                "Bông tai bạc 925",
                (190000, 490000),
                {"chất liệu": "bạc 925", "kiểu": "tối giản"},
                "earrings",
            ),
            (
                "Dây chuyền mặt đá",
                (220000, 550000),
                {"chất liệu": "thép mạ", "kiểu": "mặt đá"},
                "necklace",
            ),
            (
                "Túi clutch dự tiệc",
                (260000, 590000),
                {"chất liệu": "satin", "kiểu": "clutch"},
                "clutch_bag",
            ),
            (
                "Balo mini nữ",
                (230000, 480000),
                {"chất liệu": "da pu", "kiểu": "balo mini"},
                "backpack",
            ),
            ...
            (
                "Mũ lưỡi trai thêu",
                (120000, 260000),
                {"chất liệu": "cotton", "kiểu": "lưỡi trai"},
                "cap",
            ),
            (
                "Túi đựng mỹ phẩm",
                (90000, 220000),
                {"chất liệu": "chống nước", "kiểu": "pouch"},
                "handbag",
            ),
            (
                "Khuyên tai vòng nhỏ",
                (140000, 360000),
                {"chất liệu": "titan", "kiểu": "vòng"},
                "earrings",
            ),
        ],
    },
...
# The bundled sample represents one coherent clothing business. Keep inactive
# vocabularies in this module only for backwards-compatible schema values; they
# must never leak into the sample shop's catalogue, orders or AI evidence.
_ACTIVE_CATEGORIES = ("Thời trang", "Phụ kiện")
...
def _build() -> dict:
        ...
        for name, (lo, hi), attrs, type_key in spec["items"]:
            ...
            stock = (
                ...
                if stock_status == "out"
                    ...
                    daily * rng.randint(1, 3)
                    if stock_status == "low"
                    else daily * rng.randint(15, 60)
                )
            )
            ...
            if pid % 3 == 0:
                promo = {
                    "name": rng.choice(
                        ["Sale 11.11 -20%", "Freeship + tặng quà", "Flash sale cuối tuần -15%"]
                    ),
            ...
            competitors = []
            comp_names = [
                "Shop " + c for c in ("BestPrice", "Mega Store", "Outlet VN", "Deal Zone")
            ]
            ...
            products.append(
                {
                    ...
                    "channels": ["Shopee", "TikTok Shop", "Tiki"]
                    if pid % 4
                    else ["Shopee", "Website"],
    ...
    decisions = [
        ...
        {
            "kind": "ad",
            "description": "Ads Facebook mùa hè",
            "metric": "ROAS",
            "value": 3.4,
            "month": 6,
            "category": "Thời trang",
        ...
        {
            "kind": "inventory",
            "description": "Nhập sỉ áo khoác trước mùa lạnh",
            "metric": "sell_through_pct",
            "value": 92.0,
            "month": 10,
            "category": "Thời trang",
        },
        {
            "kind": "promo",
            "description": "Combo mua 2 tặng 1",
            "metric": "sales_lift_pct",
            "value": 25.0,
            "month": 8,
            "category": "Mỹ phẩm",
        ...
        {
            "kind": "ad",
            "description": "Ads Tết Nguyên đán",
            "metric": "ROAS",
            "value": 4.8,
            "month": 1,
            "category": "Phụ kiện",
    ...
    decisions = [item for item in decisions if item["category"] in _ACTIVE_CATEGORIES]
        ...
        customers.append(
            {
                ...
                "province": rng.choice(
                    ["TP.HCM", "Hà Nội", "Bình Dương", "Đà Nẵng", "Đồng Nai", "Cần Thơ"]
                ),
        ...
        orders.append(
            {
                ...
                else ("unpaid" if status == "pending" else "paid"),
                "items": lines,
    ...
    for product in products:
        ...
        product["trend"] = (
            "rising" if change >= 0.15 else ("cooling" if change <= -0.15 else "stable")
        )
    ...
    for customer in customers:
        ...
        completed = [
            o for o in history if o["status"] in {"delivered", "shipped", "paid", "returned"}
        ]
        if not completed:
            continue
        latest = completed[0]
        ...
        customer.update(
            {
                ...
                "recency_days": max(
                    0, (anchor - datetime.fromisoformat(latest["created_at"])).days
                ),
                ...
                "lifetime_value_vnd": sum(
                    o["total_vnd"] for o in completed if o["status"] != "returned"
                ),
    ...
    for day_offset in range(89, -1, -1):
        ...
        recognized = [
            o for o in day_orders if o["status"] not in {"cancelled", "returned", "pending"}
        ]
    ...
    sessions: list[dict] = [
        {
            "id": "S1",
            "label": "Săn áo khoác — vừa thêm giỏ",
            "video_url": "/demo-videos/s5-ao-len-hoodie.webm",
            "events": [
                {"type": "search", "category": "Thời trang", "query": "áo khoác unisex"},
                {"type": "click", "category": "Thời trang"},
                {"type": "view", "category": "Thời trang"},
                {"type": "review", "category": "Thời trang"},
                {"type": "livestream", "category": "Thời trang"},
                {"type": "cart", "category": "Thời trang"},
            ],
        },
        {
            "id": "S2",
            "label": "Lướt thời trang — chưa quyết",
            "video_url": "/demo-videos/s2-vay.webm",
            "events": [
        ...
        {
            "id": "S3",
            "label": "Mua đầm xong — có thể cross-sell",
            "video_url": "/demo-videos/s2-vay.webm",
            "events": [
                {"type": "view", "category": "Thời trang"},
                {"type": "review", "category": "Thời trang"},
        ...
        {
            "id": "S4",
            "label": "Bỏ giỏ giữa chừng — nguy cơ rời",
            "video_url": "/demo-videos/s4-tui-abandon.webm",
            "events": [
                {"type": "click", "category": "Phụ kiện"},
        ...
        {
            "id": "S5",
            "label": "Fan livestream thời trang",
            "video_url": "/demo-videos/s5-ao-len-hoodie.webm",
            "events": [
                {"type": "livestream", "category": "Thời trang"},
                {"type": "livestream", "category": "Thời trang"},
        ...
        {
            "id": "S6",
            "label": "Phụ kiện — chốt đơn nhanh",
            "video_url": "/demo-videos/s6-tui-cheo-purchase.webm",
            "events": [
                {"type": "search", "category": "Phụ kiện", "query": "túi đeo chéo"},
                {"type": "view", "category": "Phụ kiện"},
                {"type": "review", "category": "Phụ kiện"},
                {"type": "cart", "category": "Phụ kiện"},
                {"type": "purchase", "category": "Phụ kiện"},
            ],
        },
        {
            "id": "S7",
            "label": "So sánh giá áo khoác — chưa chốt",
            "video_url": "/demo-videos/s8-blazer-bounce.webm",
            "events": [
                {"type": "search", "category": "Thời trang", "query": "áo khoác denim"},
                {"type": "click", "category": "Thời trang"},
                {"type": "view", "category": "Thời trang"},
                {"type": "click", "category": "Thời trang"},
                {"type": "view", "category": "Thời trang"},
        ...
        {
            "id": "S8",
            "label": "Khách mới ghé qua — nguy cơ rời ngay",
            "video_url": "/demo-videos/s8-blazer-bounce.webm",
            "events": [{"type": "view", "category": "Thời trang"}],
        },
        {
            "id": "S9",
            "label": "Gom nhiều món rồi thanh toán",
            "video_url": "/demo-videos/s9-multi-item-checkout.webm",
            "events": [
                {"type": "view", "category": "Thời trang"},
                {"type": "cart", "category": "Thời trang"},
                {"type": "view", "category": "Thời trang"},
        ...
        {
            "id": "S10",
            "label": "Khách cũ quay lại xem thêm",
            "video_url": "/demo-videos/s10-vong-tay-then-dong-ho.webm",
            "events": [
                {"type": "purchase", "category": "Phụ kiện"},
                {"type": "search", "category": "Phụ kiện", "query": "đồng hồ"},
                {"type": "view", "category": "Phụ kiện"},
            ],
        },
    ]
    sessions = [
        ...
        if all(event.get("category") in _ACTIVE_CATEGORIES for event in session["events"])
    ]
...
def categories() -> list[str]:
    return list(_ACTIVE_CATEGORIES)
...
def similar_products(product: dict, k: int = 5) -> list[dict]:
    ...
    for q in all_products():
        ...
        if q["brand"] == product["brand"]:
            score += 1.5
        price_ratio = min(q["price_vnd"], product["price_vnd"]) / max(
            q["price_vnd"], product["price_vnd"]
        )
